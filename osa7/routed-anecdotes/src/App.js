  ...
  return (
    <Router>
      <div>
        ...
        <Route exact path='/' render={props.showAnecdotes} />
        <Route path='/create' render={props.showCreate} />
        <Route path='/about' render={props.showAbout} />
